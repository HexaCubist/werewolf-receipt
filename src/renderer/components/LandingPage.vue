        ...
        <div class="step column">
          ...
          <div class="button-group">
            <button
              ...
              @click="printcard( card_current,gameSettings.players,fromSelections=true,printReal=!print.print_test)"
            >Print a card!</button>
  ...
  export default {
      ...
      printcard: function (cardInd, players, fromSelections = null, printReal = true, cardInfo = this.cardInfo) {
        ...
        win.webContents.on('did-finish-load', ((data, win) => {
          ...
          win.webContents.send('receipt-data', {
            card: this.getcard(cardInfo, cardIndCalc),
    ...
    computed: {
      ...
      cardSelections: function () {
        ...
        console.log(selectionsUnshuffled)
